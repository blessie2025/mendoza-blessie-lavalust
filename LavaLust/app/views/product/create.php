...
<div class="container">
    ...
    <header class="header">
        <div class="header-main">
            ...
            <div>
                <h2>Add Product</h2>
                <p class="subtitle">Create a new item in your inventory</p>
            </div>
        </div>
    </header>
    ...
    <div class="form-wrap">
        ...
        <!-- OPTIONAL VALIDATION ERRORS DISPLAY -->
        <?php if (!empty($errors)): ?>
            <div class="error-box">
                <ul>
        ...
        <form action="<?= site_url('/product/create'); ?>" method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="product_name" name="product_name" required placeholder="e.g. Vintage Pink Mug">
            </div>
